...
export default function UserProfile() {
  ...
  const fetchInfoData = async () => {
    try {
      const response = await fetch('http://3.27.60.205:4002/info'); // Replace with your specific endpoint
  ...
  const fetchTechnicalData = async () => {
    try {
      const response = await fetch('http://3.27.60.205:4002/technical'); // Replace with your specific endpoint
      const jsonData = await response.json();
